...
Important Finalizer class: finalizers are not certain to be called. And my finalizers were triggered when last strong pointer (non WeakReference) had just been lost.
